...
public class BlacksmithScreen extends MyScreen{
    public BlacksmithScreen(DungeonGame dungeonGame){
        super(dungeonGame);
        ClickableActor buy = new ClickableActor(490,80,100,75,"Buy", ButtonType.NORMAL, () ->{});
        ClickableActor sell = new ClickableActor(690,80,100,75,"Sell", ButtonType.NORMAL,() ->{});
        ClickableActor forge = new ClickableActor(890,80,100,75,"Forge", ButtonType.NORMAL,() ->{});
        stage.addActor(buy);
        stage.addActor(sell);
